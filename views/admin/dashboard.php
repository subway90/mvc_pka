        ...
        <div class="row g-4 g-xl-5">
            ...
            <div class="col-12 col-lg-4 col-xxl-3 d-flex">
                <div class="card flex-grow-1 saw-pulse"
                    ...
                    <div class="sa-widget-header saw-pulse__header">
                        ...
                        <div class="sa-widget-header__actions">
                            <div class="dropdown">
                                <button type="button" class="btn btn-sm btn-sa-muted d-block" id="widget-context-menu-4"
                                    data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                    <i class="fas fa-ellipsis-v"></i>
                                </button>
            ...
            <div class="col-12 col-xxl-9 d-flex">
                <div class="card flex-grow-1 saw-table">
                    <div class="sa-widget-header saw-table__header">
                        ...
                        <div class="sa-widget-header__actions">
                            <div class="dropdown">
                                <button type="button" class="btn btn-sm btn-sa-muted d-block" id="widget-context-menu-6"
                                    data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                    <i class="fas fa-ellipsis-v"></i>
                                </button>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><img src="vendor/flag-icons/24/IT.png" class="sa-language-icon d-block" alt=""
                                            title="Italy" /></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><img src="vendor/flag-icons/24/DE.png" class="sa-language-icon d-block" alt=""
                                            title="Germany" /></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="app-customer.html"
                                ...
                                <tr>
                                    ...
                                    <td><img src="vendor/flag-icons/24/US.png" class="sa-language-icon d-block" alt=""
                                            title="USA" /></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="app-customer.html"
                                ...
                                <tr>
                                    ...
                                    <td><img src="vendor/flag-icons/24/CO.png" class="sa-language-icon d-block" alt=""
                                            title="Columbia" /></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="app-customer.html"
                                ...
                                <tr>
                                    ...
                                    <td><img src="vendor/flag-icons/24/RS.png" class="sa-language-icon d-block" alt=""
                                            title="Srbija" /></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="app-customer.html"
                                ...
                                <tr>
                                    ...
                                    <td><img src="vendor/flag-icons/24/FR.png" class="sa-language-icon d-block" alt=""
                                            title="France" /></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="app-customer.html"
                                ...
                                <tr>
                                    ...
                                    <td><img src="vendor/flag-icons/24/RU.png" class="sa-language-icon d-block" alt=""
                                            title="Russia" /></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="app-customer.html"
            ...
            <div class="col-12 col-xxl-3 d-flex">
                <div class="card flex-grow-1 saw-chart-circle"
                    data-sa-data="[
                        {&quot;label&quot;:&quot;Yandex&quot;,&quot;value&quot;:2742,&quot;color&quot;:&quot;#153252&quot;,&quot;orders&quot;:12},
                    ...
                    <div class="sa-widget-header saw-chart-circle__header">
                        ...
                        <div class="sa-widget-header__actions">
                            <div class="dropdown">
                                <button type="button" class="btn btn-sm btn-sa-muted d-block" id="widget-context-menu-7"
                                    data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                    <i class="fas fa-ellipsis-v"></i>
                                </button>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="saw-chart-circle__symbol"
                                                style="--saw-chart-circle__symbol--color:#153252"></div>
