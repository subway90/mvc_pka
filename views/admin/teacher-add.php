...
<form action="<?=URL_ADMIN?>them-giang-vien" method="post" enctype="multipart/form-data">
                                ...
                                <div class="sa-entity-layout__main">
                                    <div class="card w-100">
                                        <div class="card-body p-5 row">
                                            <div class="mb-5 h2 fs-exact-18 px-0">Thông tin</div>
                                            ...
                                            <div class="col-6 form-floating  px-1 mb-2 pb-3">
                                                <select name="degree" class="form-select" id="degree" aria-label="Floating label select example">
                                                    <?php foreach ($list_degree as $option) { ?>
                                                        <option <?= ($degree == $option['id_degree']) ? 'selected' : '' ?> value="<?= $option['id_degree'] ?>" ><?=$option['name_degree']?></option>
                                                        <?php }?>
                                                </select>
                                                <label for="degree">Học vị <span class="text-danger">&#10033;</span></label>
                                            </div>
                                            <div class="col-6 form-floating  px-1 mb-2 pb-3">
                                                <select name="position" class="form-select" id="position" aria-label="Floating label select example">
                                                    <?php foreach ($list_position as $option) { ?>
                                                        <option <?= ($position == $option['id_position']) ? 'selected' : '' ?> value="<?= $option['id_position'] ?>" ><?=$option['name_position']?></option>
                                                        <?php }?>
                                                </select>
                                            ...
                                            <div class="col-12 form-floating  px-1 mb-2 pb-3">
                                                ...
                                                <label for="major">Bộ môn <span class="text-danger">&#10033;</span></label>
                                            </div>
                                            <div class="col-12 form-floating  px-1 mb-2 pb-3">
